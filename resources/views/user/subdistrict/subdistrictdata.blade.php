                                            ...
                                            <div class="tab-pane fade in" id="second">
                                                <form action="/subprofil/updatecontactpeople" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-8">
                                                            <input id="nama_camat" name="telp_kontak" placeholder="Nama Camat" class="form-control here" value="{{ $contactpeople[0]->telp_kontak }}"  required="required" type="text">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="nama_camat" class="col-4 col-form-label">Email</label>
                                                        <div class="col-8">
                                                            <input id="nama_camat" name="email_kontak" placeholder="Nama Camat" class="form-control here" value="{{ $contactpeople[0]->email_kontak }}" required="required" type="text">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <div class="offset-4 col-8">
